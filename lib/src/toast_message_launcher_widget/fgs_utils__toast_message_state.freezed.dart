...
part of 'fgs_utils__toast_message_state.dart';
...
mixin _$FGS_UTILS__ToastMessageState {
  ...
  @JsonKey(ignore: true)
  $FGS_UTILS__ToastMessageStateCopyWith<FGS_UTILS__ToastMessageState>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $FGS_UTILS__ToastMessageStateCopyWith<$Res> {
  factory $FGS_UTILS__ToastMessageStateCopyWith(
          FGS_UTILS__ToastMessageState value,
          $Res Function(FGS_UTILS__ToastMessageState) then) =
      _$FGS_UTILS__ToastMessageStateCopyWithImpl<$Res,
          FGS_UTILS__ToastMessageState>;
  @useResult
  $Res call(
      {String uuid,
      FGS_UTILS__TranslateableMessageState? localizedMessage,
...
/// @nodoc
class _$FGS_UTILS__ToastMessageStateCopyWithImpl<$Res,
        $Val extends FGS_UTILS__ToastMessageState>
    implements $FGS_UTILS__ToastMessageStateCopyWith<$Res> {
  _$FGS_UTILS__ToastMessageStateCopyWithImpl(this._value, this._then);
...
class _$FGS_UTILS__ToastMessageState__Main
  ...
  @override
  String toString() {
    return 'FGS_UTILS__ToastMessageState.main(uuid: $uuid, localizedMessage: $localizedMessage, message: $message)';
  }
...
abstract class FGS_UTILS__ToastMessageState__Main
