...
part of 'fgs_utils__navigate_to_state.dart';
...
mixin _$FGS_UTILS__NavigateToState {
  ...
  @JsonKey(ignore: true)
  $FGS_UTILS__NavigateToStateCopyWith<FGS_UTILS__NavigateToState>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $FGS_UTILS__NavigateToStateCopyWith<$Res> {
  factory $FGS_UTILS__NavigateToStateCopyWith(FGS_UTILS__NavigateToState value,
          $Res Function(FGS_UTILS__NavigateToState) then) =
...
/// @nodoc
class _$FGS_UTILS__NavigateToStateCopyWithImpl<$Res,
        $Val extends FGS_UTILS__NavigateToState>
    implements $FGS_UTILS__NavigateToStateCopyWith<$Res> {
  _$FGS_UTILS__NavigateToStateCopyWithImpl(this._value, this._then);
